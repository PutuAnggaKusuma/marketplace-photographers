                            ...
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <span aria-current="page">
                                        <span class="inline-flex items-center px-4 py-2 -ml-px text-sm font-black text-gray-900 bg-amber-400 border border-amber-400 cursor-default leading-5 shadow-xs">{{ $page }}</span>
                                    </span>
                                @else
